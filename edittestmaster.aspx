<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="edittestmaster.aspx.cs" Inherits="WebApplication1.edittestmaster" %>
                            ...
                            <div class="card-title mb-3">Edit Test Master</div>
                             ...
                             <div class="col-md-6 form-group mb-3">
                                ...
                                <img src="userpic/TestMaster/2.gif" />
                                    ...
                                    <div class="col-md-12">
                                        <asp:LinkButton ID="lnkSubmit" CssClass="  btn btn-rounded btn-primary float-right mt-2" runat="server" Text="Submit"/>
  <asp:LinkButton PostBackUrl="~/testmasterlist.aspx" CausesValidation="false" ID="lnkCancel" CssClass="   btn btn-rounded btn-primary float-right mt-2" runat="server"  Text="Cancel"/>
                                    </div>
                                </div>
