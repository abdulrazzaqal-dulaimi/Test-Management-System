<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="adduser.aspx.cs" Inherits="WebApplication1.adduser" %>
                        ...
                        <div class="card-body">
                            <div class="card-title mb-3">Add User</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <asp:LinkButton ID="lnkSubmit" CssClass=" float-right btn btn-rounded btn-dark ml-3  mt-2" runat="server" Text="Submit"/>
  <asp:LinkButton PostBackUrl="~/userlist.aspx" CausesValidation="false" ID="lnkCancel" CssClass=" float-right btn btn-rounded btn-dark mt-2" runat="server" Text="Cancel"/>
                                    </div>
                                </div>
